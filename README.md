High Level Overview: In terms of a high level overview, there is a main message board and then there is a way to add a message.
When adding a message, it takes in a few different things and then adds the message to the main message board. The message board is structured as a form style where you can check the message off to try and remove the message, but I did not get to that functionality yet.
